...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>unsplash</title></head> <body><h1>Hello world!</h1><img src="http://${yandex_storage_bucket.dosia.bucket_domain_name}/1.jpg"/></body></html>' > index.html
EOF
    }
  }
